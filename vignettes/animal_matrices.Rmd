...
The differences in confidence are not easy to see in the density plots.

## Reproductive rates

[@beissinger1995snailkite] only provides standard deviations for nest success, the
...
not provided, but [@snyder1989snailkite] had an average of ~ 2 per nest across
...
should be reflected in the degree of confidence placed in each distribution. 
[@beissinger1995snailkite] used normal distributions for the uncertainty
...
would have fallen outside the range [0,1] for a probability. How these are
treated would affect the distribution of uncertainty, and consequently the
