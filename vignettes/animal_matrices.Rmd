...
We have a mean and standard deviation, and can obtain $\alpha$ and $\beta$ as follows
...
kite_parms <- b1995_table2 %>% 
  ...
  mutate_at(.vars = 3:12, .funs = as.numeric) %>% 
...
Fixing the standard deviation gives a consistent effect on the belief about
