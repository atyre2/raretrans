...
for weighting the prior. Note that the 1st row, 3rd column is 0.0, because this transition is 
impossible. By default the weight is 1, interpreted as a prior sample size of 1.
```{r}
...
p2 <- alpha / (alpha + beta)
lcl2 <- qbeta(0.025, alpha, beta)
ucl2 <- qbeta(0.975, alpha, beta)
