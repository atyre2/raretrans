...
We must specify the parameters for the fertility prior as a matrix. Entries representing stages that are non-reproducing or outcome stages that don't occur by reproduction should be zero. 

```{r}
alpha <- matrix(c(0, 0, 1e-5,
                  0, 0, 0,
                  0, 0, 0), nrow=3, ncol = 3, byrow = TRUE)
beta <- matrix(c(0, 0, 1e-5,
                  0, 0, 0,
                  0, 0, 0), nrow=3, ncol = 3, byrow = TRUE)
...
alpha2 <- matrix(c(0, 0, 0.025,
                  0, 0, 0,
                  0, 0, 0), nrow=3, ncol = 3, byrow = TRUE)
beta2 <- matrix(c(0, 0, 1,
                  0, 0, 0,
                  0, 0, 0), nrow=3, ncol = 3, byrow = TRUE)
