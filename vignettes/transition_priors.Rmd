...
BaseTable <- 
  tribble(~Population, ~Year, ~Stage,     ~N,        ~seedling,    ~juvenile,   ~adult,
          ...
          914,             9, "seedling", badN205[1], badA205[1,1],badA205[1,2],badA205[1,3],
          914,             9, "juvenile", badN205[2], badA205[2,1],badA205[2,2],badA205[2,3],
          914,             9, "adult",    badN205[3], badA205[3,1],badA205[3,2],badA205[3,3])
...
knitr::kable(wUnifTable, caption = "Two problematic matrices and the effects of a uniform and RLT prior with total weight equal to the sample size. &lmbd; = 0 for population 905 and &lmbd; = 1 for population 914 before applying the prior information.")
```
