...
TODO: Add line on left hand side of each plot where necessary. 
Fix shading. 
...
xx$prior <- factor(xx$prior, levels = c("None", "Uniform", "RLT, w = 1", "RLT, w = 0.5N", "RLT, w = N"))
...
ggplot(filter(xx, transition != "p to m"), aes(x = prob, y=dens)) + geom_area(alpha = 0.75, fill="red") +
