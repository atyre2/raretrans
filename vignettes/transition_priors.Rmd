...
params <- tribble(
  ...
  "Uniform", "p to a",     0.25,
  "Uniform", "p to m",     3.25,
  "RLT, \\nweight = 1", "p to p",     1.25,    
  "RLT, \\nweight = 1", "p to j",     7.05,
  "RLT, \\nweight = 1", "p to a",     0.01,
  "RLT, \\nweight = 1", "p to m",     3.69,
  "RLT, \\nweight = 0.5N", "p to p",     2.375,    
  "RLT, \\nweight = 0.5N", "p to j",     7.275,
  "RLT, \\nweight = 0.5N", "p to a",     0.055,
  "RLT, \\nweight = 0.5N", "p to m",     6.795,
  "RLT, \\nweight = N", "p to p",     3.75,    
  "RLT, \\nweight = N", "p to j",     7.55,
  "RLT, \\nweight = N", "p to a",     0.11,
  "RLT, \\nweight = N", "p to m",     10.59
) 
...
xx$prior <- factor(xx$prior, levels = c("None", "Uniform", "RLT, \\nweight = 1", "RLT, \\nweight = 0.5N", "RLT, \\nweight = N"))
...
ggplot(filter(xx, transition != "p to m"), aes(x = prob, y=dens)) + geom_area(alpha = 0.75) +
  ...
  geom_text(data=filter(params, transition != "p to m"), 
            ...
            size=3, hjust=1) + 
  rlt_theme + theme(panel.spacing.y = unit(1, "lines"),
